...
def generate_columns():
    ...
    additional_columns = [
        'lint_item_count INTEGER', 'total_quantity INTEGER', 'positions INTEGER', 
        'total_weight FLOAT', 'hub_id INTEGER', 'delivery_time TIMESTAMP',
        'bags_used INTEGER', 'bags_used_forecast FLOAT', 'cold_bags_used INTEGER',
        'cold_bags_used_forecast FLOAT', 'deep_frozen_bags_used INTEGER',
